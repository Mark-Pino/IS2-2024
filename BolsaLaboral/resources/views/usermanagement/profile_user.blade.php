                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <div class="small doj text-muted">Fecha de ingreso: {{ Session::get('join_date') }}</div>
                ...
                <div class="row user-tabs">
                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            ...
                            <li class="nav-item"><a href="#emp_projects" data-toggle="tab" class="nav-link">Projectos</a></li>
                            <li class="nav-item"><a href="#bank_statutory" data-toggle="tab" class="nav-link">Bancos y estatutos<small class="text-danger">(Admin Solo)</small></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    ...
                                    @if (!empty($userInformation))
                                        <ul class="personal-info">
                                            <li>
                                                <div class="title">Pasaporte No.</div>
                                            ...
                                            <li>
                                                <div class="title">Numero de niños</div>
