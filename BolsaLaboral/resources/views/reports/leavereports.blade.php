    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Informe de Licencias</h3>
                        <ul class="breadcrumb">
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Licencia Restante</th>
                                    <th>Total de Licencias</th>
                                    <th>Total de Licencias Tomadas</th>
                                    <th>Licencia Acumulada</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($leaves as $items)
                                    <tr>
                                        ...
                                        <td class="text-center"><span class="btn btn-danger btn-sm">{{$items->day}} Día</span></td>
