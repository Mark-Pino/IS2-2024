<div class="py-5">
    <div class="max-w-8x1 mx-auto sm:px-4 lg:px-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center p-2 rounded-md flex-1">
                <label class="w-full relative text-gray-400 focus-within:text-gray-600 block">
                    ...
                    <x-input type="text" wire:model="search" class="w-full block pl-14" placeholder="Buscar Name..."/>
                </label>
            </div>
            <!--Boton nuevo   -->
            ...
            <table class="w-full divide-y divide-gray-200 table-auto">
              <thead class="bg-indigo-500 text-white">
                <tr class="text-left text-xs font-bold  uppercase">
                  ...
                  <td scope="col" class="px-6 py-3">nombres_rs</td>
                  ...
                  <td scope="col" class="px-6 py-3">archivo_cv</td>
            ...
            Swal.fire({
              ...
              confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    //alert("del");
                    Livewire.emitTo('crud-usuario','delete',id);
                    Swal.fire(
                        'Deleted!',
