...
<div class="bodyletrero">
    <input class="letrero relative" type="text" id="input" placeholder="Ingresar Texto" value="" title="type and press enter" />
</div>
{{-- Letrero --}}
